...
export function filterTasks(tasks, filters) {
    return tasks.filter((task) => {
        ...
        if (filters.search && filters.search.trim()) {
            ...
            const matchesTags = (_b = (_a = task.tags) === null || _a === void 0 ? void 0 : _a.some((tag) => containsIgnoreCase(tag, q))) !== null && _b !== void 0 ? _b : false;
 ...
 */
export function sortTasks(tasks, sortBy, dir = 'asc') {
